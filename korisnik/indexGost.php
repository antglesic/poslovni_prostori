        ...
        <div id="cssmenu">
            <nav>
                <ul>
                    ...
                    <li>
                        <a href="gost/lokacije.php">Popis lokacija</a>
                    </li>
                    <li>
                        <a href="gost/oglasi.php">Oglasi</a>
                    </li>
                    <li>
                        <a href="gost/povratnaInformacija.php">Povratna informacija</a>
                    </li>
                    <li>
                        <a href="gost/o_autoru.html">O autoru</a>
                    </li>
                    <li>
                        <a href="gost/dokumentacija.html">Dokumentacija</a>
                    </li>
