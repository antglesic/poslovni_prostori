...
$sql_upit_placeno = "SELECT vrsta_oglasa.vrsta_oglasa, vrsta_oglasa.cijena*COUNT(oglas.vrsta_oglasa_idvrsta_oglasa), vrsta_oglasa.trajanje_oglasa FROM vrsta_oglasa, oglas WHERE oglas.vrsta_oglasa_idvrsta_oglasa LIKE vrsta_oglasa.idvrsta_oglasa GROUP BY oglas.vrsta_oglasa_idvrsta_oglasa";
$statistika = $baza->selectDB($sql_upit_placeno);

$head = "<thead>" . "<tr>" . "<th>Vrsta oglasa</th>" . "<th>Datum</th>" . "<th>Ukupno plaćeno</th>" . "</tr>" . "</thead>";
$table = "";


while ($row = mysqli_fetch_array($statistika)) {
    $table = $table . "<tr>";
    $table = $table . "<td>" . $row["vrsta_oglasa"] . "</td>" . "<td>" . $row["trajanje_oglasa"] . "</td>" . "<td>" . $row[1] . "</td>";
    $table = $table . "</tr>";
}
